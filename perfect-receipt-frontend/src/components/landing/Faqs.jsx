        ...
        <section id='faq' className='py-20 lg:py-28 bg-white'>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className='text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4'>Got Questions? We’ve Got Answers.</h2>
                    <p className='text-xl text-gray-600 max-w-3xl mx-auto'>Here are answers to some of the most common questions our users ask before and after getting started with PerfectReceipt.</p>
                </div>
